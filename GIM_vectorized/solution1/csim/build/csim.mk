...
HLS_SOURCES = ../../../main.cpp ../../../accelerator.cpp ../../../activation.cpp ../../../bias.cpp ../../../data.cpp ../../../error.cpp ../../../layer.cpp ../../../matmul.cpp
...
$(ObjDir)/activation.o: ../../../activation.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../activation.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/activation.d

$(ObjDir)/bias.o: ../../../bias.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../bias.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/bias.d
...
$(ObjDir)/error.o: ../../../error.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../error.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \
