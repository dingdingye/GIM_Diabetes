...
$(ObjDir)/activation.cpp_pre.cpp.tb.o : activation.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling activation.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bias.cpp_pre.cpp.tb.o : bias.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bias.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/data.cpp_pre.cpp.tb.o : data.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling data.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/error.cpp_pre.cpp.tb.o : error.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling error.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/layer.cpp_pre.cpp.tb.o : layer.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling layer.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c  $(IFLAG) $(DFLAG) $< -o $@; \
