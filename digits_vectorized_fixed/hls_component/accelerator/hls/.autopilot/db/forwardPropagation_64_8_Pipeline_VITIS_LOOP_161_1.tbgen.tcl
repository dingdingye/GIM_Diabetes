set moduleName forwardPropagation_64_8_Pipeline_VITIS_LOOP_161_1
set isTopModule 0
...
set C_modelName {forwardPropagation<64, 8>_Pipeline_VITIS_LOOP_161_1}
...
dict set ap_memory_interface_dict net_0 { MEM_WIDTH 64 MEM_SIZE 64 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ C_0 double 64 regular {array 8 { 1 3 } 1 1 }  }
	{ biases_val int 512 regular  }
	{ net_0 double 64 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ biases_val sc_in sc_lv 512 signal 1 } 
...
set Spec2ImplPortList { 
	...
	net_0 { ap_memory {  { net_0_address0 mem_address 1 3 }  { net_0_ce0 mem_ce 1 1 }  { net_0_we0 mem_we 1 1 }  { net_0_d0 mem_din 1 64 } } }
}
