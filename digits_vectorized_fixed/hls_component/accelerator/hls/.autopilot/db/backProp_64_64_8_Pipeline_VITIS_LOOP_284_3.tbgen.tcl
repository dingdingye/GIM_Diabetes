set moduleName backProp_64_64_8_Pipeline_VITIS_LOOP_284_3
set isTopModule 0
...
set C_modelName {backProp<64, 64, 8>_Pipeline_VITIS_LOOP_284_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict d_activation_0 { MEM_WIDTH 64 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	{ d_activation_0 double 64 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ d_activation_0_address0 sc_out sc_lv 6 signal 0 } 
	{ d_activation_0_ce0 sc_out sc_logic 1 signal 0 } 
	{ d_activation_0_q0 sc_in sc_lv 64 signal 0 } 
...
set Spec2ImplPortList { 
	d_activation_0 { ap_memory {  { d_activation_0_address0 mem_address 1 6 }  { d_activation_0_ce0 mem_ce 1 1 }  { d_activation_0_q0 mem_dout 0 64 } } }
