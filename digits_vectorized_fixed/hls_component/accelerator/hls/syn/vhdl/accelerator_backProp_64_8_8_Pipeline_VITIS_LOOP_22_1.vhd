...
entity accelerator_backProp_64_8_8_Pipeline_VITIS_LOOP_22_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of accelerator_backProp_64_8_8_Pipeline_VITIS_LOOP_22_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln23_2_fu_136_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln23_2_reg_187 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_31_fu_96_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    and_ln23_fu_146_p2 <= (or_ln23_fu_142_p2 and grp_fu_2398_p_dout0);
    ...
    ap_sig_allocacmp_i_30_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_42, ap_loop_init)
    begin
    ...
    d_activation_0_d0 <= grp_fu_2402_p_dout0;
    ...
    grp_fu_2398_p_din0 <= net_0_q0;
    grp_fu_2398_p_din1 <= ap_const_lv64_0;
    grp_fu_2398_p_opcode <= ap_const_lv5_2;
    grp_fu_2402_p_ce <= ap_const_logic_1;
    grp_fu_2402_p_din0 <= zext_ln23_fu_152_p1;
    i_31_fu_96_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_30) + unsigned(ap_const_lv4_1));
    icmp_ln22_fu_90_p2 <= "1" when (ap_sig_allocacmp_i_30 = ap_const_lv4_8) else "0";
    icmp_ln23_2_fu_136_p2 <= "1" when (trunc_ln23_fu_126_p1 = ap_const_lv52_0) else "0";
    ...
    or_ln23_fu_142_p2 <= (icmp_ln23_reg_182 or icmp_ln23_2_reg_187);
    tmp_s_fu_116_p4 <= bitcast_ln23_fu_112_p1(62 downto 52);
    trunc_ln23_fu_126_p1 <= bitcast_ln23_fu_112_p1(52 - 1 downto 0);
    zext_ln22_fu_102_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_30),64));
