...
module accelerator_forwardPropagation_8_8_Pipeline_VITIS_LOOP_13_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln14_2_fu_131_p2;
...
assign and_ln14_fu_143_p2 = (or_ln14_fu_137_p2 & grp_fu_616_p_dout0);
...
assign grp_fu_616_p_din0 = net_0_q0;

assign grp_fu_616_p_din1 = 64'd0;

assign grp_fu_616_p_opcode = 5'd2;

assign i_10_fu_92_p2 = (ap_sig_allocacmp_i + 4'd1);

assign icmp_ln13_fu_86_p2 = ((ap_sig_allocacmp_i == 4'd8) ? 1'b1 : 1'b0);

assign icmp_ln14_2_fu_131_p2 = ((trunc_ln14_fu_121_p1 == 52'd0) ? 1'b1 : 1'b0);
...
assign or_ln14_fu_137_p2 = (icmp_ln14_fu_125_p2 | icmp_ln14_2_fu_131_p2);
...
endmodule //accelerator_forwardPropagation_8_8_Pipeline_VITIS_LOOP_13_1
