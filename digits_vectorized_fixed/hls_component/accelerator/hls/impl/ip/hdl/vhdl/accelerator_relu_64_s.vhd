...
entity accelerator_relu_64_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of accelerator_relu_64_s is 
...
attribute shreg_extract : string;
    ...
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_idle : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_ready : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_net_0_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_net_0_ce0 : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_address0 : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_ce0 : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_we0 : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_d0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_din0 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_din1 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_opcode : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_ce : STD_LOGIC;
    signal grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg : STD_LOGIC := '0';
    ...
    component accelerator_relu_64_Pipeline_VITIS_LOOP_13_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        agg_result_0_we0 : OUT STD_LOGIC;
        agg_result_0_d0 : OUT STD_LOGIC_VECTOR (63 downto 0);
        grp_fu_731_p_din0 : OUT STD_LOGIC_VECTOR (63 downto 0);
        grp_fu_731_p_din1 : OUT STD_LOGIC_VECTOR (63 downto 0);
        grp_fu_731_p_opcode : OUT STD_LOGIC_VECTOR (4 downto 0);
        grp_fu_731_p_dout0 : IN STD_LOGIC_VECTOR (0 downto 0);
...
begin
    grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723 : component accelerator_relu_64_Pipeline_VITIS_LOOP_13_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state33)) then 
                    grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_ready = ap_const_logic_1)) then 
                    grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done, ap_CS_fsm_state34)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state34 => 
                if (((grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state34))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state34;
                end if;
    ...
    agg_result_0_address0_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_address0, ap_CS_fsm_state34, agg_result_0_address0_local)
    begin
    ...
    agg_result_0_ce0_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_ce0, ap_CS_fsm_state34, agg_result_0_ce0_local)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state34)) then 
            agg_result_0_ce0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_ce0;
        else 
    ...
    agg_result_0_d0_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_d0, ap_CS_fsm_state34)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state34)) then 
            agg_result_0_d0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_d0;
        else 
    ...
    agg_result_0_we0_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_we0, ap_CS_fsm_state34, agg_result_0_we0_local)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state34)) then 
            agg_result_0_we0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_agg_result_0_we0;
        else 
    ...
    ap_ST_fsm_state34_blk_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done)
    begin
        if ((grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done, ap_CS_fsm_state34)
    begin
        if ((((grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state34)) or ((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)))) then 
    ...
    ap_ready_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done, ap_CS_fsm_state34)
    begin
        if (((grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state34))) then 
    ...
    grp_fu_3163_p_ce <= grp_fu_731_ce;
    grp_fu_3163_p_din0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_din0;
    grp_fu_3163_p_din1 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_din1;
    grp_fu_3163_p_opcode <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_opcode;

    grp_fu_731_ce_assign_proc : process(grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_grp_fu_731_p_ce, ap_CS_fsm_state34)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state34)) then 
    ...
    grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_ap_start_reg;
    net_0_address0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_net_0_address0;
    net_0_ce0 <= grp_relu_64_Pipeline_VITIS_LOOP_13_1_fu_723_net_0_ce0;
end behav;
