...
entity accelerator_accelerator_Pipeline_VITIS_LOOP_40_15 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of accelerator_accelerator_Pipeline_VITIS_LOOP_40_15 is 
...
attribute shreg_extract : string;
    ...
    signal i_49_fu_290 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal i_39_fu_705_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i : STD_LOGIC_VECTOR (6 downto 0);
    signal input_T_0_1_we0_local : STD_LOGIC;
    signal tmp_s_fu_720_p131 : STD_LOGIC_VECTOR (63 downto 0);
    signal input_T_0_1_ce0_local : STD_LOGIC;
...
begin
    sparsemux_129_6_64_1_1_U3531 : component accelerator_sparsemux_129_6_64_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        CASE0 => "000000",
    ...
    i_49_fu_290_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_state1, i_49_fu_290, ap_loop_init)
    begin
    ...
    i_39_fu_705_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv7_1));
    icmp_ln40_fu_699_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv7_40) else "0";
    input_T_0_1_address0 <= zext_ln40_fu_711_p1(6 - 1 downto 0);
    input_T_0_1_ce0 <= input_T_0_1_ce0_local;

    input_T_0_1_ce0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            input_T_0_1_ce0_local <= ap_const_logic_1;
        else 
            input_T_0_1_ce0_local <= ap_const_logic_0;
        end if; 
    end process;

    input_T_0_1_d0 <= tmp_s_fu_720_p131;
    input_T_0_1_we0 <= input_T_0_1_we0_local;

    input_T_0_1_we0_local_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln40_fu_699_p2)
    begin
        if (((icmp_ln40_fu_699_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            input_T_0_1_we0_local <= ap_const_logic_1;
        else 
            input_T_0_1_we0_local <= ap_const_logic_0;
        end if; 
    end process;
