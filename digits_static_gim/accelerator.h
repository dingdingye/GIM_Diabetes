...
void accelerator(
    ...
    std::array<std::array<std::array<double, 1>, OUT_SIZE>, PROBLEM_SIZE> prev_epoch_error{0.5};

    // std::array<std::array<double, PROBLEM_SIZE>, OUT_SIZE> prev_epoch_error{0.5};            
