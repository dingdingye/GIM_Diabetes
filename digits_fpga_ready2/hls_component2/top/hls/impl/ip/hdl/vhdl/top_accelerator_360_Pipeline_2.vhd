...
entity top_accelerator_360_Pipeline_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of top_accelerator_360_Pipeline_2 is 
...
attribute shreg_extract : string;
    ...
    signal idx62_reg_100 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln43_1_fu_168_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal shl_ln4_fu_127_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal zext_ln871_fu_135_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal add_ln871_1_fu_143_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln871_1_fu_139_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal lshr_ln_fu_158_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal lshr_ln43_1_fu_173_p4 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    idx62_reg_100_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln43_1_fu_194_p2 = ap_const_lv1_0) and (icmp_ln43_fu_188_p2 = ap_const_lv1_0) and (icmp_ln880_reg_221 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
                idx62_reg_100 <= xor_ln880_fu_200_p2;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                idx62_reg_100 <= ap_const_lv1_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, icmp_ln880_reg_221, icmp_ln43_fu_188_p2, ap_CS_fsm_state3, icmp_ln43_1_fu_194_p2)
    begin
        case ap_CS_fsm is
    ...
    add_ln871_1_fu_143_p2 <= std_logic_vector(unsigned(zext_ln871_fu_135_p1) + unsigned(p_result_2));
    add_ln871_fu_153_p2 <= std_logic_vector(unsigned(zext_ln871_1_fu_139_p1) + unsigned(p_first_assign_3));
    ...
    icmp_ln43_1_fu_194_p2 <= "1" when (signed(result_l3125_q0) < signed(result_l3125_q1)) else "0";
    icmp_ln43_fu_188_p2 <= "1" when (signed(result_l3125_q1) < signed(result_l3125_q0)) else "0";
    icmp_ln880_fu_148_p2 <= "1" when (add_ln871_1_fu_143_p2 = add_ln139) else "0";
    lshr_ln43_1_fu_173_p4 <= add_ln871_fu_153_p2(5 downto 2);
    lshr_ln_fu_158_p4 <= add_ln871_1_fu_143_p2(5 downto 2);
    result_l3125_address0 <= zext_ln43_fu_183_p1(4 - 1 downto 0);
    result_l3125_address1 <= zext_ln43_1_fu_168_p1(4 - 1 downto 0);
    result_l3125_ce0 <= result_l3125_ce0_local;

    result_l3125_ce0_local_assign_proc : process(ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    result_l3125_ce1_local_assign_proc : process(ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    shl_ln4_fu_127_p3 <= (idx62_reg_100 & ap_const_lv2_0);
    xor_ln880_fu_200_p2 <= (idx62_reg_100 xor ap_const_lv1_1);
    zext_ln43_1_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_158_p4),64));
    zext_ln43_fu_183_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln43_1_fu_173_p4),64));
    zext_ln871_1_fu_139_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln4_fu_127_p3),6));
    zext_ln871_fu_135_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(shl_ln4_fu_127_p3),64));
end behav;
