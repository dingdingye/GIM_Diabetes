...
entity top_digits_features_3_4_0_ROM_AUTO_1R is 
    generic(
             DataWidth     : integer := 4; 
...
architecture rtl of top_digits_features_3_4_0_ROM_AUTO_1R is 
...
signal mem0 : mem_array := (
    ...
    12 => "0010", 13 => "0000", 14 => "0000", 15 => "0000", 
    16 => "0010", 17 => "0000", 18 => "0000", 19 => "0010", 
    20 => "0000", 21 => "0000", 22 => "0000", 23 => "0000", 
    24 => "0000", 25 => "0000", 26 => "0000", 27 => "0000", 
    28 => "0000", 29 => "0010", 30 => "0000", 31 => "0010", 
    ...
    320 => "0000", 321 => "0000", 322 => "0000", 323 => "0010", 
    ...
    372 => "0001", 373 => "0000", 374 => "0000", 375 => "0000", 
    ...
    396 => "0000", 397 => "0000", 398 => "0011", 399 => "0000", 
    ...
    436 => "0110", 437 => "0000", 438 => "0000", 439 => "0000", 
    440 => "0000", 441 => "0000", 442 => "0001", 443 => "0000", 
    ...
    516 => "0000", 517 => "0101", 518 => "0001", 519 => "0000", 
    520 => "0000", 521 => "0000", 522 => "0000", 523 => "0000", 
    524 => "0000", 525 => "0000", 526 => "0000", 527 => "0001", 
    528 => "0000", 529 => "0000", 530 => "0000", 531 => "0000", 
    532 => "0000", 533 => "0000", 534 => "0000", 535 => "0000", 
    536 => "0000", 537 => "0100", 538 => "0110", 539 => "0000", 
    ...
    556 => "0000", 557 => "0000", 558 => "1000", 559 => "0000", 
    560 => "0000", 561 => "0000", 562 => "0000", 563 => "1001", 
    564 => "0000", 565 => "0000", 566 => "0000", 567 => "0011", 
    568 => "0000", 569 => "0000", 570 => "0000", 571 => "0000", 
    572 => "0100", 573 => "0010", 574 => "0000", 575 => "0011", 
    576 => "0000", 577 => "0000", 578 => "0000", 579 => "0000", 
    580 => "0000", 581 => "0000", 582 => "0000", 583 => "0000", 
    584 => "0000", 585 => "0000", 586 => "1010", 587 => "0000", 
    588 => "0000", 589 => "0000", 590 => "0000", 591 => "0111", 
    592 => "0000", 593 => "0000", 594 => "0000", 595 => "0000", 
    596 => "1001", 597 => "0000", 598 => "0000", 599 => "0101", 
    600 => "0011", 601 => "0111", 602 => "0000", 603 => "0000", 
    604 => "0000", 605 => "0000", 606 => "0101", 607 => "0000", 
    608 => "0000", 609 => "1101", 610 => "0000", 611 => "0000", 
    612 => "0000", 613 => "0000", 614 => "0000", 615 => "0000", 
    616 => "0000", 617 => "0000", 618 => "0000", 619 => "0000", 
    620 => "0000", 621 => "0000", 622 => "0000", 623 => "0010", 
    624 => "0000", 625 => "0000", 626 => "0000", 627 => "0000", 
    628 => "0000", 629 => "0011", 630 => "0000", 631 => "0000", 
    632 => "0010", 633 => "0000", 634 => "0000", 635 => "0000", 
    ...
    652 => "0010", 653 => "0000", 654 => "0000", 655 => "0000", 
    ...
    712 => "0010", 713 => "0000", 714 => "0000", 715 => "0000", 
    ...
    732 => "0000", 733 => "0000", 734 => "0110", 735 => "0000", 
    ...
    752 => "0010", 753 => "0000", 754 => "0000", 755 => "0000", 
    ...
    904 => "0000", 905 => "0001", 906 => "0001", 907 => "0000", 
    908 => "0000", 909 => "0000", 910 => "0000", 911 => "0000", 
    912 => "0000", 913 => "0000", 914 => "0011", 915 => "0000", 
    916 => "0011", 917 => "0000", 918 => "0000", 919 => "0000", 
    ...
    944 => "0000", 945 => "0000", 946 => "0000", 947 => "0101", 
    948 => "0000", 949 => "0000", 950 => "0000", 951 => "0000", 
    952 => "0100", 953 => "0000", 954 => "0000", 955 => "0000", 
    956 => "0101", 957 => "0000", 958 => "0100", 959 => "0000", 
    960 => "0000", 961 => "0000", 962 => "0000", 963 => "0000", 
    964 => "0000", 965 => "0000", 966 => "0000", 967 => "0000", 
    968 => "0000", 969 => "0000", 970 => "0000", 971 => "0001", 
    972 => "0100", 973 => "0000", 974 => "0000", 975 => "0000", 
    976 => "0000", 977 => "0010", 978 => "0000", 979 => "0101", 
    980 => "0000", 981 => "0000", 982 => "0101", 983 => "0000", 
    984 => "0000", 985 => "0001", 986 => "0000", 987 => "0001", 
    988 => "0000", 989 => "0010", 990 => "0000", 991 => "0100", 
    992 => "0000", 993 => "0000", 994 => "0010", 995 => "0000", 
    996 => "0000", 997 => "0000", 998 => "0000", 999 => "0000", 
    1000 => "0011", 1001 => "0000", 1002 => "0000", 1003 => "0000", 
    1004 => "0000", 1005 => "0000", 1006 => "0000", 1007 => "0000", 
    1008 => "0011", 1009 => "0000", 1010 => "0000", 1011 => "0000", 
    1012 => "0000", 1013 => "0000", 1014 => "0000", 1015 => "0000", 
    1016 => "0000", 1017 => "0001", 1018 => "0000", 1019 => "0000", 
    1020 => "0000", 1021 => "0000", 1022 => "0000", 1023 => "0000", 
    1024 => "0000", 1025 => "0000", 1026 => "0000", 1027 => "0000", 
    1028 => "0000", 1029 => "0000", 1030 => "0000", 1031 => "0001", 
    1032 => "0000", 1033 => "0000", 1034 => "0000", 1035 => "0001", 
    1036 => "0000", 1037 => "0000", 1038 => "0000", 1039 => "0000", 
    1040 => "0000", 1041 => "0001", 1042 => "0000", 1043 => "0000", 
    1044 => "0000", 1045 => "0000", 1046 => "0000", 1047 => "0000", 
    1048 => "0000", 1049 => "0000", 1050 => "0000", 1051 => "0001", 
    1052 => "0000", 1053 => "0000", 1054 => "0000", 1055 => "0001", 
    ...
    1084 => "0001", 1085 => "0000", 1086 => "0000", 1087 => "0000", 
    1088 => "0000", 1089 => "0000", 1090 => "0000", 1091 => "0000", 
    1092 => "0011", 1093 => "0010", 1094 => "0110", 1095 => "0000", 
    1096 => "0000", 1097 => "0000", 1098 => "0000", 1099 => "0000", 
    1100 => "0000", 1101 => "0000", 1102 => "0100", 1103 => "0000", 
    1104 => "0000", 1105 => "0000", 1106 => "0000", 1107 => "0000", 
    1108 => "0000", 1109 => "0110", 1110 => "0000", 1111 => "0011", 
    1112 => "0000", 1113 => "0000", 1114 => "0000", 1115 => "0101", 
    ...
    1244 => "0000", 1245 => "0010", 1246 => "0000", 1247 => "0000", 
    1248 => "0010", 1249 => "0000", 1250 => "0000", 1251 => "0000", 
    1252 => "0010", 1253 => "0000", 1254 => "0000", 1255 => "0000", 
    1256 => "0000", 1257 => "0000", 1258 => "0000", 1259 => "0000", 
    1260 => "0000", 1261 => "0000", 1262 => "0000", 1263 => "0101", 
    1264 => "0000", 1265 => "0000", 1266 => "0000", 1267 => "0000", 
    1268 => "0000", 1269 => "0000", 1270 => "0000", 1271 => "0000", 
    1272 => "0000", 1273 => "0001", 1274 => "0000", 1275 => "0000", 
    ...
    1292 => "0000", 1293 => "0010", 1294 => "0000", 1295 => "0000", 
    1296 => "0001", 1297 => "0000", 1298 => "0000", 1299 => "0011", 
    1300 => "0000", 1301 => "0000", 1302 => "0000", 1303 => "0011", 
    1304 => "0000", 1305 => "0000", 1306 => "0000", 1307 => "0000", 
    1308 => "0000", 1309 => "0000", 1310 => "0000", 1311 => "0000", 
    1312 => "0000", 1313 => "0111", 1314 => "0000", 1315 => "0000", 
    1316 => "0000", 1317 => "0000", 1318 => "0000", 1319 => "0000", 
    1320 => "0000", 1321 => "0100", 1322 => "0000", 1323 => "0000", 
    1324 => "0000", 1325 => "0000", 1326 => "0000", 1327 => "0000", 
    1328 => "0000", 1329 => "0000", 1330 => "0000", 1331 => "0000", 
    1332 => "0000", 1333 => "0000", 1334 => "0000", 1335 => "0000", 
    1336 => "0000", 1337 => "0000", 1338 => "0001", 1339 => "0000", 
    1340 => "0000", 1341 => "0101", 1342 => "0000", 1343 => "0000", 
    1344 => "0001", 1345 => "0000", 1346 => "0000", 1347 => "0000", 
    1348 => "0000", 1349 => "0000", 1350 => "0001", 1351 => "0000", 
    1352 => "0000", 1353 => "0000", 1354 => "0000", 1355 => "0000", 
    1356 => "0000", 1357 => "0000", 1358 => "0000", 1359 => "0000", 
    1360 => "0000", 1361 => "0000", 1362 => "0001", 1363 => "0000", 
    1364 => "0001", 1365 => "0000", 1366 => "0000", 1367 => "0000", 
    1368 => "0000", 1369 => "0000", 1370 => "0000", 1371 => "0001", 
    1372 => "0000", 1373 => "0000", 1374 => "0000", 1375 => "1000", 
    ...
    1400 => "0000", 1401 => "0000", 1402 => "0000", 1403 => "0001", 
    ...
    1544 => "0000", 1545 => "0000", 1546 => "0000", 1547 => "0011", 
    1548 => "0000", 1549 => "0000", 1550 => "0000", 1551 => "0000", 
    1552 => "0000", 1553 => "0000", 1554 => "0000", 1555 => "0000", 
    1556 => "0000", 1557 => "0011", 1558 => "0000", 1559 => "0000", 
    1560 => "0000", 1561 => "0000", 1562 => "0000", 1563 => "0000", 
    1564 => "0000", 1565 => "0100", 1566 => "0000", 1567 => "0000", 
    ...
    1652 => "0000", 1653 => "0000", 1654 => "0100", 1655 => "0001", 
