...
module top_backProp_8_4_10_Pipeline_VITIS_LOOP_71_1_VITIS_LOOP_74_33 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        input_0_q0,
        C_33_load_out,
        C_33_load_out_ap_vld,
        C_31_load_out,
        C_31_load_out_ap_vld,
        C_29_load_out,
        C_29_load_out_ap_vld,
        C_load_out,
        C_load_out_ap_vld
);
...
output  [24:0] C_33_load_out;
output   C_33_load_out_ap_vld;
output  [24:0] C_31_load_out;
output   C_31_load_out_ap_vld;
output  [24:0] C_29_load_out;
output   C_29_load_out_ap_vld;
output  [24:0] C_load_out;
output   C_load_out_ap_vld;

reg ap_idle;
reg C_33_load_out_ap_vld;
reg C_31_load_out_ap_vld;
reg C_29_load_out_ap_vld;
...
wire   [2:0] select_ln71_7_fu_376_p3;
reg   [2:0] select_ln71_7_reg_635;
...
wire    ap_loop_init;
reg   [3:0] k_fu_118;
wire   [3:0] k_4_fu_496_p2;
reg   [3:0] ap_sig_allocacmp_k_load;
reg   [2:0] i_fu_122;
reg   [2:0] ap_sig_allocacmp_i_load;
reg   [5:0] indvar_flatten13_fu_126;
reg   [5:0] ap_sig_allocacmp_indvar_flatten13_load;
reg   [24:0] C_load_fu_130;
wire   [0:0] icmp_ln74_4_fu_501_p2;
reg   [24:0] C_29_load_fu_134;
reg   [24:0] C_31_load_fu_138;
reg   [24:0] C_33_load_fu_142;
...
wire   [2:0] i_25_fu_356_p2;
wire   [24:0] tmp_1_fu_412_p17;
wire  signed [24:0] tmp_1_fu_412_p19;
wire   [24:0] select_ln71_8_fu_461_p3;
...
wire   [2:0] tmp_1_fu_412_p1;
wire   [2:0] tmp_1_fu_412_p3;
wire   [2:0] tmp_1_fu_412_p5;
wire   [2:0] tmp_1_fu_412_p7;
wire  signed [2:0] tmp_1_fu_412_p9;
wire  signed [2:0] tmp_1_fu_412_p11;
wire  signed [2:0] tmp_1_fu_412_p13;
wire  signed [2:0] tmp_1_fu_412_p15;
wire    ap_ce_reg;
...
#0 k_fu_118 = 4'd0;
#0 i_fu_122 = 3'd0;
#0 indvar_flatten13_fu_126 = 6'd0;
#0 C_load_fu_130 = 25'd0;
#0 C_29_load_fu_134 = 25'd0;
#0 C_31_load_fu_138 = 25'd0;
#0 C_33_load_fu_142 = 25'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        C_29_load_fu_134 <= 25'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln74_4_fu_501_p2 == 1'd1) & (trunc_ln71_reg_640 == 2'd1))) begin
        C_29_load_fu_134 <= {{add_ln79_fu_480_p2[41:17]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        C_31_load_fu_138 <= 25'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln74_4_fu_501_p2 == 1'd1) & (trunc_ln71_reg_640 == 2'd2))) begin
        C_31_load_fu_138 <= {{add_ln79_fu_480_p2[41:17]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        C_33_load_fu_142 <= 25'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln74_4_fu_501_p2 == 1'd1) & (trunc_ln71_reg_640 == 2'd3))) begin
        C_33_load_fu_142 <= {{add_ln79_fu_480_p2[41:17]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        C_load_fu_130 <= 25'd0;
    end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln74_4_fu_501_p2 == 1'd1) & (trunc_ln71_reg_640 == 2'd0))) begin
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln71_fu_338_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        C_29_load_out_ap_vld = 1'b1;
    end else begin
        C_29_load_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln71_fu_338_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        C_31_load_out_ap_vld = 1'b1;
    end else begin
        C_31_load_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln71_fu_338_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        C_33_load_out_ap_vld = 1'b1;
    end else begin
        C_33_load_out_ap_vld = 1'b0;
    end
end
...
assign C_29_load_out = C_29_load_fu_134;

assign C_31_load_out = C_31_load_fu_138;

assign C_33_load_out = C_33_load_fu_142;

assign C_load_out = C_load_fu_130;

assign add_ln71_fu_344_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 6'd1);

assign add_ln79_fu_480_p0 = {{select_ln71_8_fu_461_p3}, {17'd0}};
...
assign i_25_fu_356_p2 = (ap_sig_allocacmp_i_load + 3'd1);

assign icmp_ln71_fu_338_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln74_4_fu_501_p2 = ((k_4_fu_496_p2 == 4'd8) ? 1'b1 : 1'b0);
...
assign k_4_fu_496_p2 = (select_ln71_reg_630 + 4'd1);

assign mul_ln79_fu_291_p0 = mul_ln79_fu_291_p00;

assign mul_ln79_fu_291_p00 = input_0_q0;

assign select_ln71_7_fu_376_p3 = ((icmp_ln74_fu_362_p2[0:0] == 1'b1) ? i_25_fu_356_p2 : ap_sig_allocacmp_i_load);

assign select_ln71_8_fu_461_p3 = ((icmp_ln74_reg_625[0:0] == 1'b1) ? 25'd0 : C_fu_114);

assign select_ln71_fu_368_p3 = ((icmp_ln74_fu_362_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_k_load);

assign tmp_1_fu_412_p17 = 'bx;

assign trunc_ln71_fu_396_p1 = select_ln71_7_fu_376_p3[1:0];
...
assign zext_ln71_fu_384_p1 = select_ln71_7_fu_376_p3;

assign zext_ln74_fu_400_p1 = select_ln71_fu_368_p3;

endmodule //top_backProp_8_4_10_Pipeline_VITIS_LOOP_71_1_VITIS_LOOP_74_33
