...
set C_modelName {top_Pipeline_3}
...
set C_modelArgList {
	{ biases_l3 int 25 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "biases_l3", "interface" : "memory", "bitwidth" : 25, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ biases_l3_address0 sc_out sc_lv 4 signal 0 } 
	{ biases_l3_ce0 sc_out sc_logic 1 signal 0 } 
	{ biases_l3_we0 sc_out sc_logic 1 signal 0 } 
	{ biases_l3_d0 sc_out sc_lv 25 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	biases_l3 { ap_memory {  { biases_l3_address0 mem_address 1 4 }  { biases_l3_ce0 mem_ce 1 1 }  { biases_l3_we0 mem_we 1 1 }  { biases_l3_d0 mem_din 1 25 } } }
}
