set moduleName backProp_64_8_4_Pipeline_VITIS_LOOP_31_1
set isTopModule 0
...
set C_modelName {backProp<64, 8, 4>_Pipeline_VITIS_LOOP_31_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict net_0 { MEM_WIDTH 25 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict d_activation_0 { MEM_WIDTH 18 MEM_SIZE 24 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ net_0 int 25 regular {array 8 { 1 3 } 1 1 }  }
	{ d_activation_0 int 18 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "net_0", "interface" : "memory", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "d_activation_0", "interface" : "memory", "bitwidth" : 18, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ net_0_q0 sc_in sc_lv 25 signal 0 } 
	...
	{ d_activation_0_d0 sc_out sc_lv 18 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "d_activation_0_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "d_activation_0", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	net_0 { ap_memory {  { net_0_address0 mem_address 1 3 }  { net_0_ce0 mem_ce 1 1 }  { net_0_q0 mem_dout 0 25 } } }
	d_activation_0 { ap_memory {  { d_activation_0_address0 mem_address 1 3 }  { d_activation_0_ce0 mem_ce 1 1 }  { d_activation_0_we0 mem_we 1 1 }  { d_activation_0_d0 mem_din 1 18 } } }
}
