set moduleName forwardPropagation_64_8_Pipeline_VITIS_LOOP_145_1
set isTopModule 0
...
set C_modelName {forwardPropagation<64, 8>_Pipeline_VITIS_LOOP_145_1}
...
dict set ap_memory_interface_dict C_0 { MEM_WIDTH 25 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict net_0 { MEM_WIDTH 25 MEM_SIZE 32 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ biases int 25 regular {array 8 { 1 3 } 1 1 }  }
	{ C_0 int 25 regular {array 8 { 1 3 } 1 1 }  }
	{ net_0 int 25 regular {array 8 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ biases_address0 sc_out sc_lv 3 signal 0 } 
	...
	{ net_0_address0 sc_out sc_lv 3 signal 2 } 
...
set Spec2ImplPortList { 
	...
	C_0 { ap_memory {  { C_0_address0 mem_address 1 3 }  { C_0_ce0 mem_ce 1 1 }  { C_0_q0 mem_dout 0 25 } } }
	net_0 { ap_memory {  { net_0_address0 mem_address 1 3 }  { net_0_ce0 mem_ce 1 1 }  { net_0_we0 mem_we 1 1 }  { net_0_d0 mem_din 1 25 } } }
}
