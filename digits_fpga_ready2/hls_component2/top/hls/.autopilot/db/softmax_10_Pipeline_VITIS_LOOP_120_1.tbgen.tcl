set moduleName softmax_10_Pipeline_VITIS_LOOP_120_1
set isTopModule 0
...
set C_modelName {softmax<10>_Pipeline_VITIS_LOOP_120_1}
...
set C_modelArgList {
	{ maxLogit int 25 regular  }
	{ net_0 int 25 regular {array 10 { 1 3 } 1 1 }  }
	{ maxLogit_1_out int 25 regular {pointer 1}  }
}
set hasAXIMCache 0
set hasAXIML2Cache 0
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "maxLogit", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "net_0", "interface" : "memory", "bitwidth" : 25, "direction" : "READONLY"} , 
 	{ "Name" : "maxLogit_1_out", "interface" : "wire", "bitwidth" : 25, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ maxLogit sc_in sc_lv 25 signal 0 } 
	{ net_0_address0 sc_out sc_lv 4 signal 1 } 
	{ net_0_ce0 sc_out sc_logic 1 signal 1 } 
	{ net_0_q0 sc_in sc_lv 25 signal 1 } 
	{ maxLogit_1_out sc_out sc_lv 25 signal 2 } 
	{ maxLogit_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "maxLogit", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "maxLogit", "role": "default" }} , 
 	...
 	{ "name": "maxLogit_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "maxLogit_1_out", "role": "default" }} , 
 	{ "name": "maxLogit_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "maxLogit_1_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	maxLogit { ap_none {  { maxLogit in_data 0 25 } } }
	net_0 { ap_memory {  { net_0_address0 mem_address 1 4 }  { net_0_ce0 mem_ce 1 1 }  { net_0_q0 mem_dout 0 25 } } }
	maxLogit_1_out { ap_vld {  { maxLogit_1_out out_data 1 25 }  { maxLogit_1_out_ap_vld out_vld 1 1 } } }
}
