...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_sparsemux_27_4_5_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { input_ref_0_address0 { O 6 vector } input_ref_0_ce0 { O 1 bit } input_ref_0_we0 { O 1 bit } input_ref_0_d0 { O 22 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln69 \
    op interface \
    ports { mul_ln69 { I 13 vector } } \
} "
}
