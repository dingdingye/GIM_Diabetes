...
set name top_mul_22ns_25s_47_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_sparsemux_129_6_25_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_add_42ns_42ns_42_1_1 BINDTYPE {op} TYPE {add} IMPL {dsp} LATENCY 0
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C_0 \
    op interface \
    ports { C_0_address0 { O 3 vector } C_0_ce0 { O 1 bit } C_0_we0 { O 1 bit } C_0_d0 { O 25 vector } } \
} "
} else {
