set moduleName softmax_10_Pipeline_VITIS_LOOP_138_3
set isTopModule 0
...
set C_modelName {softmax<10>_Pipeline_VITIS_LOOP_138_3}
...
set C_modelArgList {
	{ agg_result_0 int 25 regular {array 10 { 0 1 } 1 1 }  }
	{ conv_i int 25 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "agg_result_0", "interface" : "memory", "bitwidth" : 25, "direction" : "READWRITE"} , 
 	{ "Name" : "conv_i", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ conv_i sc_in sc_lv 25 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_i", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "conv_i", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_42ns_25s_25_46_1_U421", "Parent" : "0"},
...
set Spec2ImplPortList { 
	agg_result_0 { ap_memory {  { agg_result_0_address0 mem_address 1 4 }  { agg_result_0_ce0 mem_ce 1 1 }  { agg_result_0_we0 mem_we 1 1 }  { agg_result_0_d0 mem_din 1 25 }  { agg_result_0_address1 MemPortADDR2 1 4 }  { agg_result_0_ce1 MemPortCE2 1 1 }  { agg_result_0_q1 MemPortDOUT2 0 25 } } }
	conv_i { ap_none {  { conv_i in_data 0 25 } } }
}
